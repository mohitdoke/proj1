...
/* ============================================================
   ...
   work for any company, not just EasyRewardz.
   ============================================================ */
  ...
  return (
    <div className="dash">
      ...
      <div className="footnote">
        ...
        <span>
          Every card, chart, narrative, and FY/quarter grouping above is computed live from the uploaded sheet —
          nothing is hardcoded. The Business Description section and company name come from the optional "Company
          Info" sheet, if one is present. FY periods are derived from the dates in row 1 (Apr–Mar), so adding a new
          quarter's columns and re-uploading is all a refresh needs. Forecast lines in the Outlook section are a
          simple linear trend over the most recent complete quarters, not a modeled projection — treat them as
          directional only.
        </span>
      </div>
    </div>
